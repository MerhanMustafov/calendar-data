import {
  IWeekDaysLookUpLong,
  IWeekDaysLookUpShort,
  IFirstDayOfWeekLookUp
} from '../interfaces/week.types';

export const firstDayOfWeekLookUp: IFirstDayOfWeekLookUp = {
  Sun: 0,
  Mon: 1,
  Tue: 2,
  Wed: 3,
...
export const weekDaysLookUpShort: IWeekDaysLookUpShort = {
  0: [
...
export const weekDaysLookUpLong: IWeekDaysLookUpLong = {
  0: [
