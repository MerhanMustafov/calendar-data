import { IWeekDaysString } from '../interfaces/week.types';
import { IDaysInMonth, INumberOfDaysInAMonth } from '../interfaces/month.types';
import {
  getArrayOfWeekDaysStringShort,
  getFirstWeekEmptyDays,
  getLastWeekEmptyDays
} from './week.utils';
import { firstDayOfWeekLookUp } from '../constants/week.constants';
...
export function getDaysInMonth(
...
): { daysInMonth: IDaysInMonth[]; weekDaysStrings: IWeekDaysString } {
  ...
  while (_date.getMonth() === month - 1) {
    ...
    const dayNumberInMonth = _date.getDate() as INumberOfDaysInAMonth;
